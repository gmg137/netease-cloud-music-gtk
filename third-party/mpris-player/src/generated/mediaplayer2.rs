    ...
    for dbus::ConnPath<'a, C>
{
    ...
    fn raise(&self) -> Result<(), Self::Err> {
        let mut m = my_try!(self.method_call_with_args(
    ...
    F: 'static + for<'z> Fn(&'z tree::MethodInfo<tree::MTFn<D>, D>) -> &'z T,
{
    ...
    let p = p.on_get(move |a, pinfo| {
        ...
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_quit()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_fullscreen()));
        Ok(())
    });
    let fclone = f.clone();
    let p = p.on_set(move |iter, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        my_try!(d.set_fullscreen(my_try!(iter.read())));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_set_fullscreen()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_raise()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_has_track_list()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_identity()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_desktop_entry()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_supported_uri_schemes()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_supported_mime_types()));
        Ok(())
    });
    let i = i.add_p(p);
    i
