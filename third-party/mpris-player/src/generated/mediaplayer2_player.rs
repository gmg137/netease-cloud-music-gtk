    ...
    F: 'static + for<'z> Fn(&'z tree::MethodInfo<tree::MTFn<D>, D>) -> &'z T,
{
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        ...
        let offset: i64 = my_try!(i.read());
        let d = fclone(minfo);
        my_try!(d.seek(offset));
        let rm = minfo.msg.method_return();
        Ok(vec![rm])
    };
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        let mut i = minfo.msg.iter_init();
        let track_id: dbus::Path = my_try!(i.read());
        let position: i64 = my_try!(i.read());
        let d = fclone(minfo);
        my_try!(d.set_position(track_id, position));
        let rm = minfo.msg.method_return();
        Ok(vec![rm])
    };
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        let mut i = minfo.msg.iter_init();
        let uri: &str = my_try!(i.read());
        let d = fclone(minfo);
        my_try!(d.open_uri(uri));
        let rm = minfo.msg.method_return();
        Ok(vec![rm])
    };
    ...
    let p = p.on_get(move |a, pinfo| {
        ...
        let d = fclone(&minfo);
        a.append(my_try!(d.get_playback_status()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_loop_status()));
        Ok(())
    });
    let fclone = f.clone();
    let p = p.on_set(move |iter, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        my_try!(d.set_loop_status(my_try!(iter.read())));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_set(move |iter, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        my_try!(d.set_rate(my_try!(iter.read())));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_set(move |iter, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        my_try!(d.set_shuffle(my_try!(iter.read())));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_metadata()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_set(move |iter, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        my_try!(d.set_volume(my_try!(iter.read())));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_position()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_minimum_rate()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_maximum_rate()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_go_next()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_go_previous()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_play()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_pause()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_seek()));
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(my_try!(d.get_can_control()));
        Ok(())
    });
    let i = i.add_p(p);
...
impl dbus::SignalArgs for OrgFreedesktopDBusPropertiesPropertiesChanged {
    ...
    fn get(&mut self, i: &mut arg::Iter) -> Result<(), arg::TypeMismatchError> {
        self.interface_name = my_try!(i.read());
        self.changed_properties = my_try!(i.read());
        self.invalidated_properties = my_try!(i.read());
        Ok(())
    }
}
